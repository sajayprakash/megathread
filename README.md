...
- [Mobile](#mobile)
  - [Android](#android)
    - [Custom Operating Systems](#custom-operating-systems-roms)
...
> ⚠️ Avoid using Windows for privacy and security, use [Linux](#linux) instead. If you have no choice, then use the Windows LTSC version.
...
### Custom Operating Systems (Roms)

> ⚠️ You will need a device that has an unlocked bootloader to install custom operating systems. I don't recommend doing it unless you know what you are doing, else you might risk bricking your device permanently.
...
- [Aniyomi](https://aniyomi.org/) - Free and open source anime player and manga reader based on Mihon.
